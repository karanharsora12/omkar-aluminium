...
const products = [
  {
    ...
    description: "Modern aluminium doors for residential and commercial spaces.",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80",
    slug: "aluminium-doors",
  },
  {
    title: "Aluminium Windows",
    description: "Durable and elegant window systems.",
    image: "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=600&q=80",
    slug: "aluminium-windows",
  },
  {
    title: "Sliding Doors",
    description: "Smooth, modern sliding solutions.",
    image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80",
    slug: "sliding-doors",
  },
  {
    title: "Sliding Windows",
    description: "Functional and space-efficient window systems.",
  ...
  },
  {
    ...
    description: "Architectural aluminium facade solutions.",
    image: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80",
    slug: "aluminium-facades",
  },
  {
    title: "Glass & Aluminium",
    description: "Combined glass and aluminium systems.",
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {products.map((product, i) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-5">
                <h3 className="text-base font-bold text-charcoal transition-colors group-hover:text-brand-accent">
                  {product.title}
                </h3>
                <p className="mt-1.5 text-sm leading-relaxed text-graphite-light">
                  {product.description}
                </p>
                <div className="mt-4 flex items-center gap-1 text-xs font-semibold uppercase tracking-wider text-brand-accent opacity-0 transition-all duration-500 group-hover:opacity-100">
                  Explore
